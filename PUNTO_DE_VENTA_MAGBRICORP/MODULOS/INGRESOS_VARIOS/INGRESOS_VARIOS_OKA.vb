...
Public Class INGRESOS_VARIOS_OKA
    ...
    Private Sub GuardarCambiosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GuardarCambiosToolStripMenuItem.Click
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@idgasto", datalistado.SelectedCells.Item(1).Value)
            cmd.Parameters.AddWithValue("@fecha", txtfecha.Value)
    ...
    Sub ListarGRUPOS()
        ...
        Try
            abrir()
            da = New SqlDataAdapter("MOSTRAR_CONCEPTOS_EN_INGRESOS_VARIOS", conexion)
            da.Fill(dt)
            datalistadogrupodegastos.DataSource = dt
            contar()
            datalistadogrupodegastos.Columns(1).Visible = False
            datalistadogrupodegastos.Columns(5).Visible = False
            datalistadogrupodegastos.Columns(4).Visible = False
            datalistadogrupodegastos.Columns(2).Width = 260
            datalistadogrupodegastos.Columns(3).Width = 260
            Cerrar()
        Catch ex As Exception : MessageBox.Show(ex.Message)
        End Try
    ...
    Private Sub INGRESOS_VARIOS_OKA_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            Id_usuario.Text = DISTRIBUCION_DE_PRODUCTOS.TXTIDUSUARIO.Text
