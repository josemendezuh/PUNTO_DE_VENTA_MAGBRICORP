...
Public Class LISTADO_GASTOS_VARIOS
    ...
    Private Sub txtbusca_TextChanged_1(sender As Object, e As EventArgs) Handles txtbusca.TextChanged
        ...
        End With
        Dim dt As New DataTable
        Dim da As New SqlDataAdapter("BUSCAR_gastos", conexion)
        Try
            abrir()
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        ...
        GASTOS_VARIOS_FORM.PANELCOMPROBANTE.Enabled = True
        GASTOS_VARIOS_FORM.PANELPRECIOS.Enabled = True
        GASTOS_VARIOS_FORM.GuardarCambiosToolStripMenuItem.Visible = True
        GASTOS_VARIOS_FORM.GUARDARNORMAL.Visible = False


        GASTOS_VARIOS_FORM.txtidgasto2.Text = datalistado.SelectedCells.Item(2).Value
        GASTOS_VARIOS_FORM.TXTIDCONCEPTO.Text = datalistado.SelectedCells.Item(8).Value
        GASTOS_VARIOS_FORM.txtfecha.Text = datalistado.SelectedCells.Item(3).Value
        GASTOS_VARIOS_FORM.txtfecha.Value = datalistado.SelectedCells.Item(3).Value
        GASTOS_VARIOS_FORM.txtobservacion.Text = datalistado.SelectedCells.Item(6).Value
        GASTOS_VARIOS_FORM.txtnrocomprobante.Text = datalistado.SelectedCells.Item(10).Value
        GASTOS_VARIOS_FORM.txttipocomprobante.Text = datalistado.SelectedCells.Item(11).Value
        GASTOS_VARIOS_FORM.txtpantalla.Text = datalistado.SelectedCells.Item(5).Value
        GASTOS_VARIOS_FORM.TXTCONCEPTO.Text = datalistado.SelectedCells.Item(1).Value
        GASTOS_VARIOS_FORM.datalistadogrupodegastos.Visible = False
    ...
    Private Sub marcartodos_CheckedChanged(sender As Object, e As EventArgs) Handles marcartodos.CheckedChanged
        If marcartodos.Checked = True Then
            For Each fila As DataGridViewRow In datalistado.Rows
                fila.Cells(0).Value = True
            Next
        End If
        If marcartodos.Checked = False Then
            For Each fila As DataGridViewRow In datalistado.Rows
