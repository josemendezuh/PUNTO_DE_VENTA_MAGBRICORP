...
Public Class Ver_gastos_ingresos
    ...
    Private Sub contar()
        Dim x As Integer
        x = datalistado_gastos.Rows.Count
    ...
    Private Sub datalistado_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles datalistado_gastos.CellClick
        Try
            txtidgasto.Text = datalistado_gastos.SelectedCells.Item(1).Value
            txtfecha.Text = datalistado_gastos.SelectedCells.Item(2).Value

            txtnrocomprobante.Text = datalistado_gastos.SelectedCells.Item(3).Value
            txttipocomprobante.Text = datalistado_gastos.SelectedCells.Item(4).Value

            txtpantalla.Text = datalistado_gastos.SelectedCells.Item(5).Value
            txtobservacion.Text = datalistado_gastos.SelectedCells.Item(6).Value

            txtestadook.Text = datalistado_gastos.SelectedCells.Item(7).Value
            TXTIDCONCEPTO.Text = datalistado_gastos.SelectedCells.Item(8).Value
    ...
    Private Sub cbeliminar_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbeliminar.CheckedChanged
        If cbeliminar.CheckState = CheckState.Checked Then
            datalistado_gastos.Columns.Item("Eliminar").Visible = True
        Else
            datalistado_gastos.Columns.Item("Eliminar").Visible = False
        End If
    End Sub
    ...
    Private Sub datalistado_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles datalistado_gastos.CellDoubleClick
    ...
    Private Sub MarcarTodosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MarcarTodosToolStripMenuItem.Click
        ...
        For Each fila As DataGridViewRow In datalistado_gastos.Rows
    ...
    Private Sub EDITARToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EDITARToolStripMenuItem.Click
        ...
        datalistado_gastos.Enabled = False
    ...
    Private Sub EliminarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EliminarToolStripMenuItem.Click
        ...
        If result = DialogResult.OK Then
            Try
                For Each row As DataGridViewRow In datalistado_gastos.Rows
    ...
    Sub INGRESAR_GASTO_ENTRADA()
        ...
        End Try
    End Sub
    Private Sub GUARDARNORMAL_Click(sender As Object, e As EventArgs)
        ...
        ElseIf cheknoconsiderarguiaderemision.Checked = False Then
    ...
    Private Sub Ver_gastos_ingresos_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub listar_gastos()
        ...
        datalistado_gastos.Columns(0).Width = 50
        datalistado_gastos.Columns(1).Width = 50
        datalistado_gastos.Columns(2).Width = 140
        datalistado_gastos.Columns(3).Visible = False
        datalistado_gastos.Columns(4).Width = 110
        datalistado_gastos.Columns(5).Width = 140
        datalistado_gastos.Columns(6).Width = 90
        datalistado_gastos.Columns(7).Width = 200
        datalistado_gastos.Columns(8).Visible = False
        datalistado_gastos.Columns(9).Visible = False

        datalistado_gastos.Columns(10).Width = 185



        Me.datalistado_gastos.EnableHeadersVisualStyles = False
        Dim styCabeceras As DataGridViewCellStyle = New DataGridViewCellStyle()
        styCabeceras.BackColor = Color.White
        styCabeceras.ForeColor = Color.Black
        styCabeceras.Font = New Font("Segoe UI", 10, FontStyle.Regular Or
        FontStyle.Bold)
        Me.datalistado_gastos.ColumnHeadersDefaultCellStyle = styCabeceras
        sumar()
    End Sub
    Sub listar_INGRESOS()
        Dim dt As New DataTable
    ...
    Private Sub buscar()
        ...
        '        datalistado_gastos.DataSource = dv
        '        contar()
        '        For Each fila As DataGridViewRow In datalistado_gastos.Rows
        ...
        '        Next
        '        datalistado_gastos.Columns(2).Width = 345
        '        datalistado_gastos.Columns(6).Width = 140
        '        datalistado_gastos.Columns(7).Width = 140
        '    Else
        '        inexistente.Visible = True
        '        datalistado_gastos.DataSource = Nothing
        '        contar()
    ...
    Private Sub tocultar_Click(sender As Object, e As EventArgs)
        Close()
    ...
    Private Sub laber_Click(sender As Object, e As EventArgs) Handles laber.Click
        listar_gastos()
        PanelG.Visible = True
        PanelI.Visible = False
    End Sub
    ...
    Private Sub datalistado_gastos_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado_gastos.CellContentClick
