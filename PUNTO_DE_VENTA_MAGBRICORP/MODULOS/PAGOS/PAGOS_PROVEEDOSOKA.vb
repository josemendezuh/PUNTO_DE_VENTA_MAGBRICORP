...
Imports System.IO
Public Class PAGOS_PROVEEDOSOKA
    ...
    Private Sub PAGOS_PROVEEDOSOKA_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Panel13.Location = New Point((Width - Panel13.Width) / 2, (Height - Panel13.Height) / 2)
        ...
        'txtclientesolicitante.Text = "Buscar beneficiario"
        txtmonto.Text = "Monto a abonar"
        lblavisoform.Text = "OCULTO"
        ...
        'Me.Location = New Point((Width - Me.Width) / 2, (Height - Me.Height) / 2)
    ...
    Sub cargarPROVEEDORES()
        ...
        Try
            abrir()
            da = New SqlDataAdapter("buscar_cliente_POR_nombre_PARA_PAGOS", conexion)
            da.SelectCommand.CommandType = 4
    ...
    End Sub
    Sub mostrar_DETALLE_CONTROL_DE_PAGOS()
        Dim dt As New DataTable
        Dim da As SqlDataAdapter
        Try
            abrir()
            da = New SqlDataAdapter("mostrar_DETALLE_CONTROL_DE_PAGOS", conexion)
            da.SelectCommand.CommandType = 4
    ...
    Sub cargar_estado_de_cuenta()
        ...
        Try
            abrir()
            da = New SqlDataAdapter("mostrar_estado_de_cuenta_de_proveedores", conexion)
            da.SelectCommand.CommandType = 4
            da.SelectCommand.Parameters.AddWithValue("@Id_proveedor", lblidcliente.Text)
            da.Fill(dt)
    ...
    Private Sub datalistadoclientes_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistadoclientes.CellClick
        ...
        Try
            ...
            mostrar_DETALLE_CONTROL_DE_PAGOS()
    ...
    Sub insertar_detalle_PAGO_a_PROVEEDOR()
        Try
            ...
            cmd.Parameters.AddWithValue("@Detalle", "PAGO")
        ...
        If e.ColumnIndex = Me.datalistadoMovimientos.Columns.Item("Eli").Index Then
            ...
            If result = DialogResult.OK Then
                ...
                Try
                    ...
                    Next
                    Call mostrar_DETALLE_CONTROL_DE_PAGOS()
                    Call Saldo()
    ...
    Private Sub Label9_Click(sender As Object, e As EventArgs)
        Try
            ...
            If montoreferencia >= monto Then
                insertar_detalle_PAGO_a_PROVEEDOR()
                cobrar_a_PROVEEDOR()
    ...
    Private Sub TimerostrarForm_Tick(sender As Object, e As EventArgs) Handles TimerostrarForm.Tick
        Me.Height = Me.Height + 10
        If Me.Height = 620 Then TimerostrarForm.Stop()
    End Sub

    Private Sub TimerocultarForm_Tick(sender As Object, e As EventArgs) Handles TimerocultarForm.Tick
        If Me.Height > 90 Then
            Me.Height = Me.Height - 10
        End If
        If Me.Height = 90 Then TimerocultarForm.Stop()
    End Sub
